...
export default function Hero() {
  return (
    <section className="flex flex-col justify-center items-center min-h-screen bg-gray-900 text-white px-4 text-center">
      <h1 className="text-4xl md:text-6xl font-bold mb-4">Hey, I'm Manjitha 👋</h1>
      ...
      <a href="#projects" className="px-6 py-3 text-sm tracking-[2px] bg-indigo-600 hover:bg-indigo-700 rounded-lg mt-4">
        View Projects
      </a>
    </section>
  );
